...
Getapps 是小米应用商店海外版，视觉风格基于 HyperOS 3 设计语言。

| 特征 | 说明 |
|------|------|
| HyperOS 3 风格 | 圆润、现代、简洁，遵循小米设计语言 |
| 大圆角体系 | 8 级圆角梯度（4~999px），卡片 20px，弹窗 36px，按钮 16/999px |
| 三色体系 | Getapps 默认绿色 #05C474，社区模块黄色 #FFE249，OS 系统蓝色 #3482FF，通过 CSS 变量切换 |
| 移动端优先 | 392px 基准宽度，无 :hover 只有 :active，44px 最小触控区 |
| 毛玻璃材质 | 浮起态标题栏、玻璃按钮使用 backdrop-filter blur |
| Token 驱动 | 所有视觉属性由 Token 定义，支持明暗模式自动切换 |
| 内容穿透 | 状态栏/标题栏可透明，内容延伸到顶部 |
